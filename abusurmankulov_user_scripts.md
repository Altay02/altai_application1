Домашнее задание 1 (разработка отчёта - творческое задание)

- придумай исследовательский вопрос (ИВ)
- определи контроллируемые переменные (зависимую и независимые)
- разработай и запусти собственный опрос для подтверждения или опровержения ИВ (использовать не менее 3 типов вопроса, не менее одного из каждого блока Google Forms)
- прислать ссылку на опрос
- результаты опроса с репрезентативной выборкой понадобятся к 14 ноября
